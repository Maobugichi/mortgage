...
export default function Result({result,isMortgage,isRepaid}) {
   ...
   return(
    <div className="bg-slate-900 lg:w-[48%] w-full lg:h-auto lg:min-h-[115vh] h-auto min-h-[60vh] lg:rounded-bl-[100px] lg:rounded-tr-3xl lg:rounded-br-3xl grid items-center lg:block">
