...
export default function Main() {
  ...
  return(
    <main className="overflow-x-hidden font-custom-font lg:h-[130vh] h-[190vh]  bg-red bg-green-300 lg:grid lg:items-center">
      <section className=" shadow-lg lg:w-[80%]  lg:mx-auto lg:pl-6 lg:h-auto lg:min-h-[110vh] h-auto min-h-[140vh]   lg:rounded-3xl justify-between flex lg:flex-row flex-col w-full  items-center">
